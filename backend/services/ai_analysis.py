...
"""
        ...
        return await self._call_llm(prompt, self._get_system_prompt("variance"))
...
Be specific and actionable. Adapt your advice to this category."""
        ...
        return await self._call_llm(prompt, self._get_system_prompt("savings"))
...
"""
        ...
        return await self._call_llm(prompt, self._get_system_prompt("summary"))
...
Answer concisely and helpfully."""
        ...
        return await self._call_llm(prompt, self._get_system_prompt("general"))
