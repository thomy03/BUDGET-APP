      ...
      <Card>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">Configuration des revenus et répartition</h3>
              <div className="mt-2 text-sm text-blue-700">
                <p>Cette section configure les revenus du foyer et la méthode de répartition des dépenses.</p>
                <p className="mt-1">Les provisions personnalisées peuvent être configurées dans l'onglet "Mes Dépenses".</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-blue-50 rounded-lg p-4 space-y-2">
            <div className="flex justify-between items-center">
              <span className="font-medium text-blue-900">Revenu brut total:</span>
            ...
            <div className="flex justify-between items-center">
              <span className="font-medium text-green-900">Revenu net total (après impôts):</span>
      ...
      <div className="p-6">
        ...
        {loadingProvisions ? (
          ...
          <div className="text-center py-8 text-gray-500">
            <p className="mb-4">Aucune provision configurée</p>
            <p className="text-sm">Allez dans l'onglet "Mes Dépenses" pour créer des provisions</p>
          </div>
        ) : (
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">{provision.icon || '💰'}</span>
                    <div>
                      <h3 className="font-medium text-gray-900">
                        {provision.name}
                      </h3>
                      {provision.description && (
                        <p className="text-sm text-gray-500">{provision.description}</p>
                      )}
                    </div>
                  </div>
